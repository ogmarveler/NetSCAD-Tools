...
{
    public partial class RoundedSurface(string file, double round_r, bool center = false, bool invert = false, int convexity = 1, double scaleX = 1, double scaleY = 1, double scaleZ = 1, double round_h = 0.0, int resolution = 360) : IScadObject, IDbSerializable
    {
