...
{
    [RequiresUnreferencedCode("ShapeView constructor uses code that may require unreferenced code.")]
    public ShapeView()
    {
        InitializeComponent();
        DataContext = App.Services!.GetRequiredService<ShapeViewModel>();
        LoadMarkdownAsync("avares://NetGenCAD.UI/Assets/Guides/Shape.markdown");  // Relative or absolute path
    }
